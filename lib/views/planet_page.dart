...
class PlanetPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BaseScaffold(body: BlocBuilder<PlanetCubit, PlanetState>(
        builder: (context, state) {
          return Column(
            children: [
              ...
              if (state is PlanetStateFailure) Text(state.exception.message),
              if (state is PlanetStateLoading)
